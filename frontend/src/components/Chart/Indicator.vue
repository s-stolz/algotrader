<template>
  <div class="indicator-wrapper">
    ...
    <lightweight-chart id="indicator-chart" ref="indicatorChart" :parentChart="chart" />
      ...
      <div>
        <div id="indicator-tab-wrapper">
          <span id="indicator-tab">
            ...
            <button @click="showTab = 'style'" :class="{ active: showTab == 'style' }">
              Style
            </button>
          </span>
        ...
        <table v-if="showTab == 'settings'">
          ...
          >
            ...
            <td>
              <select
                v-if="parameter.type == 'string' && parameter.options !== null"
              ...
              <input
                v-else-if="parameter.type == 'string' && parameter.options === null"
                type="text"
                v-model="parameter.value"
              />
        ...
        <table v-else-if="showTab == 'style'">
          <template v-for="(output, outputKey) in info.outputs" :key="outputKey">
                ...
                >
                  ...
                  <td v-if="typeof subValue === 'number'">
                    <input
                      ...
                      :min="1"
                      @change="updateStyles(outputKey)"
                      v-model="styles[outputKey].plotOptions[styleKey][subKey]"
                    />
                  </td>
...
export default {
  ...
  methods: {
    ...
    updateStyles(output) {
      this.$refs.indicatorChart.updateOptions(output, this.styles[output].plotOptions);
    },
  },
