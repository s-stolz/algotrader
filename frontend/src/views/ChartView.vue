<template>
  <div>
    <div id="wrapper-select">
      ...
      >
        <option v-for="timeframe in timeframes" :key="timeframe.value" :value="timeframe">
          {{ timeframe.name }}
        </option>
      </select>

      <button id="indicator-button" @click="showIndicatorModal = true">Indicator</button>
    </div>
    ...
    >
      ...
      <template #footer>
        <button @click="this.$refs.symbolForm.addSymbol()" class="footer-add-symbol">
          Add Symbol
        </button>
...
import LightweightChart from "@/components/Chart/LightweightChart.vue";
import SymbolSearchModal from "@/components/Modals/SymbolSearchModal.vue";
import SymbolFormModal from "@/components/Modals/SymbolFormModal.vue";
import IndicatorSearchModal from "@/components/Modals/IndicatorSearchModal.vue";
import Indicator from "@/components/Chart/Indicator.vue";
...
export default {
  ...
  components: {
    ...
    "symbol-search": SymbolSearchModal,
    "symbol-form": SymbolFormModal,
    "indicator-search": IndicatorSearchModal,
    indicator: Indicator,
    modal: Modal,
  },
